...
namespace X_Android
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Intent implizieterIntent = new Intent(Intent.ActionView, Android.Net.Uri.Parse("https://www.google.de"));
            ...
            //Am Beispiel des Öffnens eines neuen Layouts in der aktuellen Applikation
